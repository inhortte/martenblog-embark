module.exports = {
  ...
  // merges with the settings in default
  // used with "embark run mustelidnet" and/or "embark blockchain mustelidnet"
  mustelidnet: {
    networkType: "livenet",
    networkId: "1337",
    syncMode: "light",
    rpcCorsDomain: "http://localhost:8997",
    wsOrigins: "http://localhost:8997",
    account: {
      address: "0x15f88a46df54cb1533f5bee144e1f1b10698b4a6",
      password: "./etc/mustelidnet-password" // Password to unlock the account
    },
  },
